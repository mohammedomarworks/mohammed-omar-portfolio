      ...
      <Container>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative pl-6 sm:pl-8 border-l-2 border-indigo-500/40 dark:border-indigo-500/30">
            {/* Timeline node icon */}
            <div className="absolute -left-[17px] top-0 p-1.5 rounded-full bg-white dark:bg-slate-900 border-2 border-indigo-600 text-indigo-600 dark:text-indigo-400 shadow-sm">
              <GraduationCap className="w-4 h-4" />
            </div>

            <div className="p-6 sm:p-8 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
                <div className="flex items-center gap-2 mb-3 text-xs font-mono uppercase tracking-wider text-slate-500 dark:text-slate-400 font-semibold">
