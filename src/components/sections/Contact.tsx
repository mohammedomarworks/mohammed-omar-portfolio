    ...
    <section id="contact" className="py-20 sm:py-28 border-t border-slate-200/80 dark:border-slate-800/80">
      <Container>
        <SectionHeader
          ...
          description="Open for project collaborations, technical discussions, and software engineering opportunities."
        />
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/90 dark:border-slate-800 p-6 sm:p-10 shadow-sm">
            ...
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
              Whether you want to discuss one of my projects, explore a collaboration, or just connect regarding software development, my inbox is open.
            </p>
            ...
            <div className="p-4 sm:p-5 rounded-xl bg-slate-50 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700/80 mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  href={`mailto:${portfolioData.email}`}
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-semibold text-white bg-sky-600 hover:bg-sky-500 transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 shadow-sm"
                >
                  <span>Compose</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {githubLink && (
                <a
                  ...
                  className="group flex items-center justify-between p-4 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-sky-500/50 dark:hover:border-sky-400/50 hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-all"
                >
                  <div className="flex items-center gap-3">
