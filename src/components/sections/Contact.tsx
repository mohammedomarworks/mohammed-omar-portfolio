      ...
      <Container>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 p-6 sm:p-10 shadow-sm">
            ...
            {/* Email Action Box */}
            <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700/80 mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
